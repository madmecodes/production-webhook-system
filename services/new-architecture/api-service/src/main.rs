...
// ==============================================================================
// NEW ARCHITECTURE LAYER 1: ATOMIC EVENT CAPTURE
// ==============================================================================
//
// This service demonstrates the first layer of reliability:
// 1. Payment is saved to database
// 2. PostgreSQL trigger automatically creates event in same transaction
// 3. Guarantee: If payment committed, event DEFINITELY exists
// 4. Sequin reads from WAL and streams to Kafka
//
...
async fn main() {
    ...
    info!("✅ Using PostgreSQL triggers for ATOMIC event capture");
    info!("✅ Events flow via Sequin → Kafka → Restate → Svix");
